...
Start with the [README](README.md) installation instructions. This repository uses Python 3.12 / PyTorch / DuckDB.
...
```sh
uv run ruff check src tests scripts dashboard.py
uv run pytest -q
uv run python scripts/verify_artifacts.py
python3 .github/scripts/check_docs.py
```

The [existing CI workflow](.github/workflows/ci.yml) records the full
