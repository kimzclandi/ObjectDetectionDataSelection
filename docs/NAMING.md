...
This project is now **Detection Data Selection** (`detection-data-selection`), previously `driving-data-engine`.
...
```sh
git remote set-url origin https://github.com/kimzclandi/detection-data-selection.git
```
